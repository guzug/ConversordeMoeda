...
while True:
    ...
    while True:
        try:
            ...
            print("\033[31m Opa! Entrada invalida.  Insira um valor valido\33[0;0m")
    ...
    while cod_moeda_inicial not in (1, 2, 3):
        ...
        try:
            ...
            if cod_moeda_inicial ==1:
                ...
                print("cod de escolhas:", cod_moeda_inicial)
                break
            ...
            print("\033[1;131m Opa! entrada invalida:( SELECIONE AS OPÇÕES DISPONIVEIS\33[0;0m")
        
        
        
    titulo('SELECIONE A MOEDA DE CAMBIO')
    ...
    while cod_moeda_cambio not in(1, 2, 3):
        ...
        try:
            ...
            print("\033[1;31m Opa! entrada invalida: SELECIONE AS OPÇÕES DISPONIVEIS\33[0;0m")
